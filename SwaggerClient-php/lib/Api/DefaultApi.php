...
class DefaultApi
{
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->canceljobWithHttpInfo ($job_id);
        return $response; 
    }
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->executeWithHttpInfo ($body);
        return $response; 
    }
    ...
    public function executeWithHttpInfo($body = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'POST',
                $queryParams, $httpBody,
                $headerParams, '\Swagger\Client\Model\ExecutionResults'
            );
            if (!$response) {
                return array(null, $statusCode, $httpHeader);
            }
            ...
            switch ($e->getCode()) { 
            case 200:
                $data = \Swagger\Client\ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\ExecutionResults', $e->getResponseHeaders());
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getSwaggerDocumentWithHttpInfo ($api_version);
        return $response; 
    }


    /**
     * getSwaggerDocumentWithHttpInfo
     *
     * Get swagger API document for the web service
     *
     * @param string $api_version API version (optional, default to 2.0)
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getjobstatusWithHttpInfo ($job_id);
        return $response; 
    }
    ...
    public function getjobstatusWithHttpInfo($job_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\Swagger\Client\Model\BatchExecutionStatus'
            );
            ...
            return array(\Swagger\Client\ObjectSerializer::deserialize($response, '\Swagger\Client\Model\BatchExecutionStatus', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = \Swagger\Client\ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\BatchExecutionStatus', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->startjobWithHttpInfo ($job_id);
        return $response; 
    }
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->submitjobWithHttpInfo ($body);
        return $response; 
    }


    /**
     * submitjobWithHttpInfo
     *
     * Submit an asynchronous job to execute the web service
     *
     * @param \Swagger\Client\Model\BatchExecutionRequest $body Batch execution request (optional)
