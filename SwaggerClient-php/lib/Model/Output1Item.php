...
class Output1Item implements ArrayAccess
{
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'output1Item';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['scored_labels'] = isset($data['scored_labels']) ? $data['scored_labels'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['scored_labels'] === null) {
            $invalid_properties[] = "'scored_labels' can't be null";
        }
    ...
    {
        return $this->container['scored_labels'];
    }

    /**
     * Sets scored_labels
     * @param double $scored_labels
     * @return $this
     */
    public function setScoredLabels($scored_labels)
    {
        $this->container['scored_labels'] = $scored_labels;
